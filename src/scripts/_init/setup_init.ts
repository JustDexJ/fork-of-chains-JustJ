...
const setup_ = {
  ...
  qu: {} as { [k in UnitCriteriaKey | BuiltinUnitCriteriaKey]: UnitCriteria },
  equipment: {} as RegistryWithBuiltins<Equipment, BuiltinEquipmentKey>,
  equipmentpool: {} as RegistryWithBuiltins<
    EquipmentPool,
    BuiltinEquipmentPoolKey
  >,
  ...
  item: {} as RegistryWithBuiltins<Item, BuiltinItemKey>,
  ...
  unitgroup: {} as RegistryWithBuiltins<UnitGroup, BuiltinUnitGroupKey>,
