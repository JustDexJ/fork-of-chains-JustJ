...
import { OngoingEndOther } from "../../OngoingEndOther";

export class PhallusHoleEndOther extends OngoingEndOther {
  /**
  ...
  rawStory(sex: SexInstance): string | string[] {
    ...
    story += setup.SexUtil.afterPenetrationReactionDom(
      me,
      them,
      [
      ...
      [`continue ${fuck}ing a|reps ${hole}`, `continue ${fuck}ing a|rep`],
      sex,
    );
