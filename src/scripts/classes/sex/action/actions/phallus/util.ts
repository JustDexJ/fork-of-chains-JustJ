...
function rawPhallusHoleSizeDifferenceStart(
  me: Unit,
 ...
 */
export function phallusHoleSizeDifferenceStart(
  me: Unit,
  my_bodypart: SexBodypart,
  them: Unit,
  their_bodypart: SexBodypart,
  ...
  const raw_story = rawPhallusHoleSizeDifferenceStart(
    me,
    my_bodypart,
    them,
    their_bodypart,
...
function rawPhallusHoleSizeDifferenceOngoing(
  me: Unit,
  my_bodypart: SexBodypart,
  them: Unit,
  their_bodypart: SexBodypart,
 ...
 */
export function phallusHoleSizeDifferenceOngoing(
  me: Unit,
  my_bodypart: SexBodypart,
  them: Unit,
  their_bodypart: SexBodypart,
  ...
  const raw_story = rawPhallusHoleSizeDifferenceOngoing(
    me,
    my_bodypart,
    them,
    their_bodypart,
...
function rawPhallusHoleSizeDifferenceOngoingSub(
  me: Unit,
  my_bodypart: SexBodypart,
  them: Unit,
  their_bodypart: SexBodypart,
 ...
 * Describes unit inserting their shaft into another unit
 */
export function phallusHoleSizeDifferenceOngoingSub(
  me: Unit,
  my_bodypart: SexBodypart,
  them: Unit,
  their_bodypart: SexBodypart,
  ...
  const raw_story = rawPhallusHoleSizeDifferenceOngoingSub(
    me,
    my_bodypart,
    them,
    their_bodypart,
