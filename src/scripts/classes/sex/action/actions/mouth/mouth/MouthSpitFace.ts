...
export class SpitFace extends SexAction {
  getTags() {
  ...
  getActorDescriptions() {
    return [
      {
        energy: setup.SexConstants.ENERGY_SMALLMEDIUM,
  ...
  rawStory(sex: SexInstance): string | string[] {
    ...
    if (them.isMasochistic()) {
      ...
      t = [
        ...
        ${them.isYou() ? `your eyes.` : `a|their bitch's b|eyes.`}`,
