...
export class PenisMouthDomRough extends PenisMouthDomBase {
  getTags() {
  ...
  getActorDescriptions() {
    return [
      ...
      },
      {
        ...
        discomfort: setup.SexConstants.DISCOMFORT_MEDIUMLARGE,
  ...
  rawStory(sex: SexInstance): string | string[] {
    ...
    if (
      mypose
        .getFacingHeight(setup.sexbodypart.penis, myposition, sex)
        .facing.isUpDown()
    ) {
      t = [
      ...
      if (me.isHasTrait("dick_demon")) {
        t.push(
          `Spreading a|their knees out on either side of b|reps head, a|rep violently a|thrust downwards, burying a|their a|dick deep down b|reps throat. Grinding the base against b|their lips for moment, a|they then a|proceed to start roughly fucking b|their face, causing b|rep to let out a muffled moan as b|they b|struggle to breathe, and, squirming about beneath a|rep, b|they b|feel b|their throat being raked by the series of barbs that line the sides of a|their a|dick.`,
        );
      } else if (me.isHasTrait("dick_werewolf")) {
        t.push(
          `Spreading a|their knees out on either side of b|reps head, a|rep violently a|thrust downwards, burying a|their a|dick deep down b|reps throat. Grinding the base against b|their lips for moment, a|they then a|proceed to start roughly fucking b|their face, causing b|rep to let out a muffled moan as b|they b|struggle to breathe, and, squirming about beneath a|rep, b|they b|feel b|their lips being repeatedly battered by the fat knot at the base of a|their a|dick.`,
        );
      }
    } else {
      t = [
