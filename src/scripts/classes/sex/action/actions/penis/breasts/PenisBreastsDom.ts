...
import { SexBodypart_Breasts } from "../../../../bodypart/bodyparts/breasts";
import type { SexInstance } from "../../../../engine/SexInstance";
import { PenisBreastsDomBase } from "./PenisBreastsBase";

export class PenisBreastsDom extends PenisBreastsDomBase {
  getTags() {
    return super.getTags().concat(["dom"]);
  }
  desc() {
    return "Continue receiving titfuck / pecjob";
  }
  ...
  rawStory(sex: SexInstance): string | string[] {
    ...
    t = [];
    if (titfuck_type == SexBodypart_Breasts.TITFUCK.titfuck) {
    ...
    } else if (titfuck_type == SexBodypart_Breasts.TITFUCK.pecjob) {
      t = [
