...
export class PenisBreastsDomBallsFocus extends PenisBreastsDomBase {
  getTags() {
    return super.getTags().concat(["dom", "mouth"]);
  }
  desc() {
    return "Receive titfuck / pecjob into mouth";
  }
  ...
  getActorDescriptions() {
    return [
      ...
      {
        energy: setup.SexConstants.ENERGY_MEDIUMLARGE,
        arousal: setup.SexConstants.AROUSAL_TINY,
        discomfort: setup.SexConstants.DISCOMFORT_SMALLMEDIUM,
