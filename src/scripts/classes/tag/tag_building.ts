...
export type BuildingTag = keyof typeof BUILDING_TAGS;
...
export const BUILDING_TAGS = {
  ...
  structural: {
    type: "type",
    title: "Structural",
    description: "Foundations of your fort",
  },
  ...
  office: {
    type: "type",
    title: "Office",
    description: "Desk job and red tape",
  },
  ...
  storage: {
    type: "type",
    title: "Inventory",
    description: "Dealing with items and equipments",
  },
  ...
  recreation: {
    type: "type",
    title: "Recreation",
    description: "Recreation Wing and its upgrades",
  },

  heal: {
    type: "type",
    title: "Heal",
    description: "Healing and treating your units",
  },
  ...
  decoration: {
    type: "type",
    title: "Decoration",
    description: "Fort decoration and minor skill boosts",
  },
