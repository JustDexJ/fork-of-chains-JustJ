...
export const QUESTTAGS = {
  ...
  furry: {
    ...
    title: "Furry",
    description:
      "Heavy emphasis on furry species such as werewolves and tigerkin. This does not completely ban all furry content -- just those that feature furries in a sexual way. Neko (cat ears but otherwise human) are not considered furries",
  },
  scaley: {
    type: "fetish",
    hide: true,
    title: "Scaley",
    description:
      "Heavy emphasis on scaley species such as lizardkin and dragonkin. This does not completely ban all scaley content -- just those that feature scalies in a sexual way",
  },
  transformation: {
    type: "fetish",
    hide: true,
  ...
  watersport: {
    ...
    title: "Watersport",
    description:
      "Heavy emphasis on the consumption of urine. Note that banning watersport does not ban watersport slave training, but will instead censor all its descriptions. There are only few of this content in the game. Extreme versions of this fetish are not included in the game, due to legal reasons",
  },
  monstersex: {
    type: "fetish",
    hide: true,
    title: "Monster sex",
    description:
      "Heavy emphasis on sexual intercourse with monsters and other non-humanlikes. There are only an extremely limited amount of this content in the game. Bestiality is not included, due to legal reasons",
  },
  gore: {
    type: "fetish",
    hide: true,
    title: "Blood",
    description:
      "Containing description of blood and mild violence. The game does not contain excessive violence",
  },
  breeding: {
    type: "fetish",
    hide: true,
    title: "Breeding",
    description:
      "Heavy emphasis procreating. Note that playable units cannot become pregnant. Instead, some quests may contain brief mentions of pregnancy and/or breeding. There are only an extremely limited amount of this content in the game",
  },
  ...
  veteran: {
    ...
    title: "Veteran",
    description:
      "A quest that is only scouted after you build the Veteran Hall",
  },
  prep: {
    type: "type",
  ...
  playercapture: {
    ...
    description:
      "A random event with this tag will be chosen when the player is captured",
  },
} satisfies Record<string, TagMetadata>;

export const QUESTTAGS_DEFAULT_PANORAMA = "questcardfort";

export const QUESTTAGS_PANORAMA = {
  vale: "questcardvale",
