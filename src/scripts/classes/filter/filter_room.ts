...
export const _MENUS_room: FilterMenu<RoomInstance> = {
  tag_location: {
    title: "Location",
    default: "All",
    icon_menu: true,
  ...
  status: {
    ...
    options: {
      used: {
        title: "Placed",
        filter: (a) =>
          !State.variables.roomlist.getRoomCount(a.getTemplate()).unplaced,
      },
      free: {
        title: "Unplaced",
        filter: (a) =>
  ...
  sort: {
    ...
    options: {
      ...
      heightdown: {
        title: down("Height"),
        sort: (a, b) =>
          a.getTemplate().getHeight() - b.getTemplate().getHeight(),
      },
      heightup: {
        title: up("Height"),
        sort: (a, b) =>
          b.getTemplate().getHeight() - a.getTemplate().getHeight(),
      },
    },
  },
