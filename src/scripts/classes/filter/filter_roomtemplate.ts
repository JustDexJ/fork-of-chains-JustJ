import type { RoomTemplate } from "../room/RoomTemplate";
...
function getSkillFilter(skill_key: SkillKey) {
  return (a: RoomTemplate) => a.isHasSkillBonusOn(setup.skill[skill_key]);
}
...
export const _MENUS_roomtemplate: FilterMenu<RoomTemplate> = {
  tag_location: {
    title: "Location",
    default: "All",
    icon_menu: true,
