...
export default class SlaveOrderSeaborneRescueItHasToBeYouNouveauRichePirate extends SlaveOrderTemplate {
  constructor() {
    super();
    ...
    this.criteria = setup.CriteriaHelper.Name(
      "Nouveau Riche Pirate Order",
      setup.qu.slave,
    );
