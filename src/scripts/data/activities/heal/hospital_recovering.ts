export default {
  ...
  tags: [],
  actors: {
    a: [qres.Job("slaver"), qres.IsInjured(1)],
  },
  critical_traits: [],
  disaster_traits: [],
  restrictions: [],
  ...
  dialogues: [
    {
      ...
      actor: "a",
      texts: {
        friendly: ["Ouch... that stings.", "Oww... my body feels so bad."],
        bold: [
        ...
        cool: ["...ouch.", "The hospital is quiet, at least. I like it."],
        witty: [
