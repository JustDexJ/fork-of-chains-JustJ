...
export default definitions<FurnitureDefinition>()({
  f_drinktray_none: {
    name: "floor",
    description: "Drink from a depression on the floor",
    value: 0,
    slot: "drinktray",
    tags: ["basic"],
    skillmods: {},
  ...
  f_drinktray_normal: {
    name: "water bowl",
    description: "A small water bowl for your slaves to drink from",
    value: "FURNITURE_PRICE_NORMAL",
    slot: "drinktray",
    tags: ["normal"],
    skillmods: {
      social: "FURNITURE_SKILL_NORMAL",
    },
    texts: {
      ambience: [
  ...
  f_drinktray_master: {
    ...
    texts: {
      ...
      bedchamber:
        "The luxurious chalice is placed on the floor, forcing the slaves to crawl on all four to lap the water from the chalice.",
    },
  },

  f_drinktray_good_slaver: {
    name: '"guard dog" drink tray',
    description:
    ...
    texts: {
      ...
      bedchamber:
        "The slaves have to go on all fours to lap up their drink from the tray, careful not to touch any of its sharp spikes.",
    },
  },
  ...
  f_drinktray_normal_pitfight: {
    ...
    texts: {
      ...
      bedchamber:
        "The slaves are used to going down on all fours to lap up their drink from the charity bowl. Sometimes other things are generously put inside it too to spice up the taste",
    },
  },
});
