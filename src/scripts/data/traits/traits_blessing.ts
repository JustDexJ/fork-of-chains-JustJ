...
export default typedObject<TraitOrGroupDefinition>()({
    ...
    sequence: [
      {
        ...
        description:
          ...
          8 * setup.CURSE_INJURY_WEEKS +
          " weeks) (8 stacks, max)",
        slave_value: 8 * setup.CURSE_VALUE,
        skill_bonuses: {},
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          7 * setup.CURSE_INJURY_WEEKS +
          " weeks) (7 stacks)",
        slave_value: 7 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          6 * setup.CURSE_INJURY_WEEKS +
          " weeks) (6 stacks)",
        slave_value: 6 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          5 * setup.CURSE_INJURY_WEEKS +
          " weeks) (5 stacks)",
        slave_value: 5 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          4 * setup.CURSE_INJURY_WEEKS +
          " weeks) (4 stacks)",
        slave_value: 4 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          3 * setup.CURSE_INJURY_WEEKS +
          " weeks) (3 stacks)",
        slave_value: 3 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          2 * setup.CURSE_INJURY_WEEKS +
          " weeks) (2 stacks)",
        slave_value: 2 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      },
      {
        ...
        description:
          "Multiplies injury duration (up to additional " +
          1 * setup.CURSE_INJURY_WEEKS +
          " weeks) (1 stacks)",
        slave_value: 1 * setup.CURSE_VALUE,
        skill_bonuses: {},
        tags: ["curse"],
      ...
      null,
      {
        key: "blessing_protection1",
        name: "blessing of protection (1)",
        description:
          "Prevents up to " +
          1 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection2",
        name: "blessing of protection (2)",
        description:
          "Prevents up to " +
          2 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection3",
        name: "blessing of protection (3)",
        description:
          "Prevents up to " +
          3 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection4",
        name: "blessing of protection (4)",
        description:
          "Prevents up to " +
          4 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection5",
        name: "blessing of protection (5)",
        description:
          "Prevents up to " +
          5 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection6",
        name: "blessing of protection (6)",
        description:
          "Prevents up to " +
          6 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection7",
        name: "blessing of protection (7)",
        description:
          "Prevents up to " +
          7 * setup.BLESSING_INJURY_WEEKS +
      ...
      {
        key: "blessing_protection8",
        name: "blessing of protection (8)",
        description:
          "Prevents up to " +
          8 * setup.BLESSING_INJURY_WEEKS +
  ...
  "group:trauma_blessing": {
    ...
    sequence: [
      ...
      null,
      {
        key: "blessing_sanity1",
        name: "blessing of sanity (1)",
        description:
          "Prevents up to " +
          1 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity2",
        name: "blessing of sanity (2)",
        description:
          "Prevents up to " +
          2 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity3",
        name: "blessing of sanity (3)",
        description:
          "Prevents up to " +
          3 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity4",
        name: "blessing of sanity (4)",
        description:
          "Prevents up to " +
          4 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity5",
        name: "blessing of sanity (5)",
        description:
          "Prevents up to " +
          5 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity6",
        name: "blessing of sanity (6)",
        description:
          "Prevents up to " +
          6 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity7",
        name: "blessing of sanity (7)",
        description:
          "Prevents up to " +
          7 * setup.BLESSING_TRAUMA_WEEKS +
      ...
      {
        key: "blessing_sanity8",
        name: "blessing of sanity (8)",
        description:
          "Prevents up to " +
          8 * setup.BLESSING_TRAUMA_WEEKS +
